...
public class ManajemenAkunPengguna8 {
    private static Map<String, AkunPengguna> akunPengguna = new HashMap<>();

    public static void main(String[] args) {
        // Membuat contoh akun pengguna
        AkunPengguna pengguna1 = new AkunPengguna("bylaaaurelia_", "password123");
        AkunPengguna pengguna2 = new AkunPengguna("bylaaaurelia_", "pass456");
